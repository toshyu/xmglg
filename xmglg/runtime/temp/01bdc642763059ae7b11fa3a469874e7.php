<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\ad\index.html";i:1561342205;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\header.html";i:1561340064;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\footer.html";i:1561340164;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="example">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].name}}</td>                                 
                                <td>
                                    <img src="/uploads/images/{{d[i].images}}" style="height: 30px" onerror="this.src='/xmglg/public/static/admin/images/no_img.jpg'"/>                                  
                                </td> 
...
$(document).ready(function() { $(".i-checks").iCheck({ checkboxClass: "icheckbox_square-green", radioClass: "iradio_square-green", }) });
    ...
    function ad_state(val) {
        $.post('<?php echo url("ad_state"); ?>', { id: val },
            function(data) {
