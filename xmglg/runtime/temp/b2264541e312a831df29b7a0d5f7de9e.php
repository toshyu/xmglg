<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\member\index.html";i:1561342487;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\header.html";i:1561340064;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\footer.html";i:1561340164;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="example">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    <img src="/uploads/face/{{d[i].head_img}}" class="img-circle" style="width:35px;height:35px" onerror="this.src='/xmglg/public/static/admin/images/head_default.gif'"/>                                  
                                </td>
                                <td>{{d[i].integral}}</td>                                  
                                <td>{{d[i].money}}</td>
                                <td>{{d[i].mobile}}</td>
