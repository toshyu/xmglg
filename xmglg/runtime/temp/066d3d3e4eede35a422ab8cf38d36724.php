<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\article\edit_article.html";i:1561342269;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\header.html";i:1561340064;s:85:"D:\phpstudy\PHPTutorial\WWW\xmglg\public/../application/admin\view\public\footer.html";i:1561340164;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <select class="form-control m-b chosen-select" name="cate_id" id="cate_id">
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if($article['cate_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?> </option> <?php endforeach; endif; else: echo "" ;endif; endif; ?> </select> </div> </div> <div class="hr-line-dashed">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        ...
                                        <img id="img_data" height="100px" style="float:left;margin-left: 50px;margin-top: -10px;" onerror="this.src='/xmglg/public/static/admin/images/no_img.jpg'" src="/uploads/images/<?php echo $article['photo']; ?>" />
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-9">
                                        <script src="/xmglg/public/static/admin/ueditor/ueditor.config.js" type="text/javascript"></script>
                                        <script src="/xmglg/public/static/admin/ueditor/ueditor.all.js" type="text/javascript"></script>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="radio i-checks">
                                            <input type="radio" name='status' value="1" <?php if($article['status'] == 1): ?>checked<?php endif; ?>/>开启&nbsp;&nbsp; <input type="radio" name='status' value="0" <?php if($article['status'] == 0): ?>checked<?php endif; ?>/>关闭 </div> </div> </div> <div class="hr-line-dashed"></div>
                                        <div class="form-group">
...
$(document).ready(function() { $(".i-checks").iCheck({ checkboxClass: "icheckbox_square-green", radioClass: "iradio_square-green", }) });
    ...
    var uploader = WebUploader.create({
        ...
        swf: '/xmglg/public/static/admin/js/webupload/Uploader.swf', // swf文件路径 
